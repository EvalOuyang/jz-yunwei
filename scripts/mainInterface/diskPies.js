...
define(function(require) {
    ...
    var tpl = require('../../components/mainInterface/diskPieList.tpl')
    ...
    function DiskPies() {
        ...
        svg.append('g').attr('class', 'disk-pies').attr('transform', 'translate(0,250)')
    }
     ...
     */
    DiskPies.prototype.updateData = function(data) {
        // drawGroupPies(data.diskUser, '.disk-pies')
    ...
    function bindPieClickEvent(pie) {
        pie.on('click', function(d, i) {
            ...
            //对主机列表排序
            data.list.sort(function(a, b) { return parseInt(b.cipan) - parseInt(a.cipan) })
